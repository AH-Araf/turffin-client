  ...
  return (
    <div className={`${inter.className} min-h-screen bg-turf-surface text-turf-on-surface antialiased`}>
      <main className="mx-auto max-w-7xl px-6 py-6 pb-16">
        <nav aria-label="Breadcrumb" className="mb-6 text-xs font-semibold uppercase tracking-widest text-turf-on-surface-variant">
        ...
        <div className="mb-6 flex flex-col justify-between gap-4 md:flex-row md:items-end">
          <div>
            <h1 className={`${lexend.className} text-3xl font-bold leading-tight tracking-[-0.02em] text-turf-on-surface md:text-5xl`}>
              {t.title}
            </h1>
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 lg:gap-10">
          <div className="lg:col-span-2">
            <div className="mb-8 grid h-[300px] grid-cols-1 grid-rows-2 gap-3 overflow-hidden rounded-xl md:grid-cols-4 md:grid-rows-2 md:gap-4 md:h-[500px]">
            ...
            <section
              className="mb-10 flex flex-col gap-4 rounded-2xl border border-turf-primary/10 bg-turf-primary/5 p-6 shadow-turf-glow md:flex-row md:items-center md:justify-between"
            >
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 rounded-xl border border-slate-200 bg-white p-6 shadow-xl">
