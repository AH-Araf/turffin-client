    ...
    <div className={`${inter.className} min-h-screen bg-turf-surface text-turf-on-surface antialiased`}>
      <main>
        <section className="relative overflow-hidden py-10 md:py-14">
          <div className="mx-auto grid max-w-7xl items-center gap-8 px-4 md:px-6 lg:grid-cols-2 lg:gap-10">
            <div>
              <span
              ...
              <h1 className={`${lexend.className} mb-4 text-3xl font-bold leading-tight tracking-[-0.02em] md:text-4xl`}>
                Democratizing access to professional-grade surfaces.
              </h1>
              <p className="mb-6 max-w-xl text-base text-turf-on-surface-variant">
        ...
        <section className="bg-turf-surface-low py-10 md:py-14">
          <div className="mx-auto max-w-7xl px-4 md:px-6">
        ...
        <section className="py-10 md:py-14">
          <div className="mx-auto max-w-7xl px-4 md:px-6">
            <div className="mb-8 flex flex-col items-end justify-between gap-5 md:mb-10 md:flex-row">
        ...
        <section className="px-4 pb-12 md:px-6">
          <div className="relative mx-auto max-w-7xl overflow-hidden rounded-4xl bg-slate-950 p-8 md:p-12">
