...
export function SupportInquiryForm() {
  ...
  if (sent) {
    return (
      <div
        className={`${lexend.className} rounded-xl border border-slate-100 bg-white p-8 shadow-turf-glow md:p-12`}
        role="status"
      >
  ...
  return (
    <div
      className="rounded-xl border border-slate-100 bg-white p-8 shadow-turf-glow md:p-12"
    >
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <div className="space-y-2">
            <label
              ...
              className={`${lexend.className} ml-1 text-sm font-semibold text-turf-on-surface-variant`}
            >
              Email address
            </label>
            <input
