      ...
      <main>
        <section className="relative overflow-hidden bg-white py-10 md:py-16">
          ...
          <div className="relative z-10 mx-auto max-w-7xl px-6 text-center">
            ...
            <h1 className={`${lexend.className} mb-6 text-4xl font-bold tracking-[-0.02em] text-turf-on-surface md:text-5xl`}>
              Contact our team
            </h1>
        ...
        <section className="bg-turf-surface-low py-10 md:py-16">
          <div className="mx-auto max-w-7xl px-6">
            <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
              <div className="flex flex-col items-center rounded-xl border border-slate-100 bg-white p-8 text-center shadow-turf-glow">
                <HelpIcon />
