  ...
  return (
    <div className={`${inter.className} min-h-screen bg-turf-surface text-turf-on-surface antialiased`}>
      <main className="mx-auto max-w-7xl px-6 pb-16 pt-4">
        <div className="mb-10">
          <h1 className={`${lexend.className} mb-2 text-4xl font-bold leading-tight tracking-[-0.02em] text-turf-on-surface md:text-5xl`}>
            Elite Sporting Grounds
          </h1>
          <p className="text-lg text-turf-on-surface-variant">Find and book the highest-rated turfs in Bangladesh.</p>
        </div>

        <div className="flex flex-col gap-8 lg:flex-row">
          <aside className="w-full shrink-0 lg:w-72">
            <div className="sticky top-28 rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              {turfs.map((t) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="mb-6 flex items-center gap-1 text-sm text-turf-on-surface-variant">
