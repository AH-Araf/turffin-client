...
export function LoginView() {
  ...
  return (
    <div
      className={`${inter.className} fixed inset-0 z-100 flex min-h-0 flex-col text-turf-on-surface antialiased`}
    >
      ...
      <main className="relative z-10 mx-auto flex w-full min-h-0 max-w-[480px] flex-1 flex-col justify-center px-6 py-10">
        ...
        <div className="rounded-xl border border-white/10 bg-white p-8 shadow-2xl md:p-10">
          ...
          {message ? (
            <p className="mb-4 rounded-lg border border-slate-200 bg-turf-surface-low px-4 py-3 text-sm text-turf-on-surface-variant">
              {message}
            </p>
          ) : null}
          ...
          <form className="space-y-6" onSubmit={onSubmit}>
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-slate-200 bg-white py-3 pl-10 pr-4 text-turf-on-surface transition focus:border-turf-primary-container focus:outline-none focus:ring-2 focus:ring-turf-primary-container/30"
                />
              </div>
            </div>
            ...
            <div className="flex items-center">
              <input
                ...
                name="remember"
                type="checkbox"
                className="h-4 w-4 rounded border-slate-300 text-turf-primary focus:ring-turf-primary-container"
              />
            ...
            <button
              type="submit"
              className={`${lexend.className} w-full rounded-lg bg-turf-primary-container py-4 text-lg font-bold text-turf-on-primary-container shadow-lg transition hover:brightness-105 active:scale-[0.98] md:text-base md:leading-7`}
              style={{ boxShadow: "0 10px 15px -3px rgba(74, 222, 128, 0.2)" }}
            >
              Sign in
            </button>
          </form>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center">
              <span
                className={`${lexend.className} bg-white px-4 text-xs font-semibold uppercase tracking-widest text-slate-500`}
              >
                Or continue with
              </span>
            </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              ...
              className="flex items-center justify-center gap-2 rounded-lg border border-slate-200 py-3 text-turf-on-surface transition hover:bg-slate-50 active:scale-95"
            >
            ...
            <button
              type="button"
              onClick={() => setMessage("Facebook sign-in is coming soon.")}
              className="flex items-center justify-center gap-2 rounded-lg border border-slate-200 py-3 text-turf-on-surface transition hover:bg-slate-50 active:scale-95"
            >
          ...
          <div className="mt-8 border-t border-slate-200 pt-6 text-center">
            <p className="text-turf-on-surface-variant">
              ...
              <Link
                href="/register"
                className="ml-1 font-bold text-turf-primary decoration-turf-primary underline-offset-4 hover:underline"
              >
                Join Turffin
              </Link>
            </p>
